...
<head>
    <head>
        ...
        <!-- PLUGINS CSS STYLE -->
        <link href="assets/login/plugins/toaster/toastr.min.css" rel="stylesheet" />
        <link href="assets/login/plugins/nprogress/nprogress.css" rel="stylesheet" />
        <link href="assets/login/plugins/flag-icons/css/flag-icon.min.css" rel="stylesheet"/>
        <link href="assets/login/plugins/jvectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet" />
        <link href="assets/login/plugins/ladda/ladda.min.css" rel="stylesheet" />
        <link href="assets/login/plugins/select2/css/select2.min.css" rel="stylesheet" />
        <link href="assets/login/plugins/daterangepicker/daterangepicker.css" rel="stylesheet" />

        <!-- SLEEK CSS -->
        <link id="sleek-css" rel="stylesheet" href="assets/login/css/sleek.css" />



        <!-- FAVICON -->
        <link href="assets/login/img/favicon.png" rel="shortcut icon" />
        ...
        <![endif]-->
        <script src="assets/login/plugins/nprogress/nprogress.js"></script>
    </head>
...
<script src="assets/login/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
</body>
</html>